  ...
  const handleSave = useCallback((newItem) => {
    setConsultas((prevConsultas) => {
      const updatedConsultas = newItem.id
        ...
        : [...prevConsultas, { ...newItem, id: prevConsultas.length + 1 }];
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View>
          <Text style={styles.sectionTitleDown}>Caso precise encontrar uma consulta antiga ou atual, use o campo de pesquisa ou de filtro.</Text>
        </View>
        {consultas.map((item) => (
