...
export default function LoginScreen({ navigation }) {
  ...
  <View style={styles.container}>
    ...
    <View>
      ...
      <Image source={require('../key-visual/yaso1.png')} style={styles.logo} />
    ...
    <View style={styles.backgroundWithButtons}>
      <View style={styles.contentContainer}>
        <TextInput
          style={[styles.input, { marginTop: 50, fontStyle: 'italic', fontColor: '9A9A9A' }]}
          placeholder="nome"
          value={username}
      ...
      <View>
        <TouchableOpacity style={styles.buttonEmergency}>
          <Image  source={require('../key-visual/emergencia.png')} style={styles.emergencyIcon} />
